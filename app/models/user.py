...
Svaki korisnik (admin, knjiznicar, citac) pripada jednoj knjižnici.
Globalni admin nema library_id (NULL) — vidi sve.
"""
import enum
...
class User(Base):
    ...
    member_id       = Column(Integer, nullable=True)   # Povezani član
