...
class Token(BaseModel):
    ...
    role: str
    full_name: str
    expires_in: int  # Sekunde do isteka tokena
...
async def refresh_token(current_user: User = Depends(get_current_user)):
    """Obnovi JWT token za trenutno prijavljenog korisnika.
    Poziva se automatski iz desktop aplikacije prije isteka tokena.
    """
